...
public class MappingRulesDetailCache extends BaseGuavaCache{
    ...
    @Autowired
    private ITbMappingRulesDetailDao tblMappingRulesDetailDao;
    ...
    protected List<TblMappingRulesDetail> loadData(Object requestID) {
        return tblMappingRulesDetailDao.queryGrpcMappingRulesDetailsByRequestID(Integer.valueOf(requestID.toString()));
    }
