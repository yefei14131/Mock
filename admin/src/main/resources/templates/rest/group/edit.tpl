...
<div class="layui-body">
	...
	<div class="content-head">
		<span class="layui-breadcrumb">
		  <a href="">HTTP</a>
		  <a href="javascript:history.back()">分组</a>
		  <a><cite>编辑</cite></a>
		</span>
	</div>
	<hr>
	<form class="layui-form" action="//mock_server/rest/group/save" method="post" id="item-form"  style="padding: 15px;">
	  ...
	  <#list fields as field >
		<div class="layui-form-item">
			...
			<#else>
				<div class="layui-input-block">
					<input type="text" name="${field.fieldName}" <#if ('groupCode' == field.fieldName || 'groupName' == field.fieldName) > required  lay-verify="required" </#if>  placeholder="${field.fieldName}" autocomplete="off" class="layui-input" <#if 'sortIndex' == field.fieldName > value="99" </#if> >
				</div>
			</#if>
		 </div>
	  </#list>
