...
import org.yefei.qa.mock.service.impl.SystemNoticeHandler;
...
public class SystemNoticeListener<T> {
    ...
    public void handleMessage(T message) {
        try {
            ...
            if (systemNotice.getNoticeConsumerList().contains(SystemNoticeConsumer.REST) || systemNotice.getNoticeConsumerList().contains(SystemNoticeConsumer.ALL)) {
